...
function redirectToFallingExpressionsGamePage() {
    window.location.href = '../../game/expressions/falling-expressions.html?difficulty=' + encodeURIComponent(getQueryParam('difficulty') * 1000) +
...
function redirectToFallingExpressionsMenuPage() {
    window.location.href = '../../menu/falling-expressions-menu.html';
}